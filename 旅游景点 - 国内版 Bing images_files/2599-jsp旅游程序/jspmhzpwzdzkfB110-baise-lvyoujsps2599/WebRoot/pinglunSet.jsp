...
<form action="<%=path %>/pinglunSet.action" method="post" name="formAdd" >
	评论修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="biaoti" id="biaoti" value="${requestScope.pinglun.biaoti }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<textarea name="neirong" style="width:670px;height:200px;visibility:;">${requestScope.pinglun.neirong }</textarea>
							</td>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="shijian" id="shijian" size="90" value="${requestScope.pinglun.shijian }" />
						    </td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
						        <select name="jingdianid" id="jingdianid" style="width: 280px;">
									<option value="${requestScope.pinglun.jingdian.id }">${requestScope.pinglun.jingdian.biaoti }</option>
								</select>
						    </td>
						...
						<tr>
                            ...
                            <td width="90%" bgcolor="#FFFFFF" align="left">
                                <select name="usersid" id="usersid" style="width: 280px;">
                                    <option value="${requestScope.pinglun.users.id }">${requestScope.pinglun.users.loginname }</option>
                                </select>
                            </td>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="hidden" name="id" value="${requestScope.pinglun.id }"/>
