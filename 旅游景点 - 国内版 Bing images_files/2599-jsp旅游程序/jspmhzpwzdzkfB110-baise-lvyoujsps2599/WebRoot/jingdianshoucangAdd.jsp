...
<body onload="init()">
<form action="<%=path %>/shoucangAdd.action" method="post" id="formAdd" name="formAdd">
    景点收藏添加
    <br><br>
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            ...
            <td width="90%" bgcolor="#FFFFFF" align="left">
                <select name="jingdianid"
                        id="jingdianid" style="width: 280px;">
                    <option value="${requestScope.jingdian.id }">${requestScope.jingdian.biaoti }</option>
                </select>
            </td>
        </tr>
