...
<head>
	...
	<script language="javascript">
		...
		function dateDiff(){
			...
			//document.getElementById("jine").value = result*${requestScope.xianlu.id };
		}
...
<div class="wrapper">
	<div class="news_con">
		<div class="news_list_con clearfix">
			...
			<form action="<%=path %>/yuyueAddQian.action" method="post" name="formAdd" id="formAdd" >
				<table width="98%" height="516" border="1" align="center" cellpadding="3" cellspacing="1"
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="2">
							<%--<input type="hidden" name="xianluid" value="${requestScope.xianlu.id }"/>--%>
