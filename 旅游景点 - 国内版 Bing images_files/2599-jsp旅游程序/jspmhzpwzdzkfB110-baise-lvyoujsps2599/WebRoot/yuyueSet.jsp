...
<form action="<%=path %>/yuyueSet.action" method="post" name="formAdd" >
	预约修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="biaoti" id="biaoti" value="${requestScope.yuyue.biaoti }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="xingming" id="xingming" value="${requestScope.yuyue.xingming }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="dianhua" id="dianhua" value="${requestScope.yuyue.dianhua }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="beizhu" id="beizhu" value="${requestScope.yuyue.beizhu }" size="90"/>
							</td>
