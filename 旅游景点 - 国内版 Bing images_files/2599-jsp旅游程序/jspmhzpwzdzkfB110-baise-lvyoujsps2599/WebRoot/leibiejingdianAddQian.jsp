...
<head>
	...
	<script language="javascript">
		...
		function dateDiff(){
			...
			//document.getElementById("jine").value = result*${requestScope.leibie.id };
		}
...
<div class="wrapper">
	<div class="news_con">
		<div class="news_list_con clearfix">
			...
			<form action="<%=path %>/jingdianAddQian.action" method="post" name="formAdd" id="formAdd" >
				<table width="98%" height="516" border="1" align="center" cellpadding="3" cellspacing="1"
					...
					<tr>
						...
						<td >
							<select name="leibieid" id="leibieid"
								...
								<option value="${requestScope.leibie.id }">${requestScope.leibie.mingcheng }</option>
						...
						<tr>
							...
							<td>
								<input type="text" name="image" id="image" size="50" readonly="readonly"/>
						...
						<tr>
							...
							<td>
								<input type="text" name="jiage" id="jiage" size="70"/>
							</td>
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="2">
							<%--<input type="hidden" name="leibieid" value="${requestScope.leibie.id }"/>--%>
