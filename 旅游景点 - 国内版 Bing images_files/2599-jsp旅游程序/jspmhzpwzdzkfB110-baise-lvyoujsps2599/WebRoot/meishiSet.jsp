...
<form action="<%=path %>/meishiSet.action" method="post" name="formAdd" >
	美食修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="biaoti" id="biaoti" value="${requestScope.meishi.biaoti }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<textarea name="neirong" style="width:670px;height:200px;visibility:;">${requestScope.meishi.neirong }</textarea>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="dizhi" id="dizhi" value="${requestScope.meishi.dizhi }" size="90"/>
							</td>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="image" id="image" value="${requestScope.meishi.image }" size="50" readonly="readonly"/>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="shijian" id="shijian" size="90" value="${requestScope.meishi.shijian }" />
						    </td>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="hidden" name="id" value="${requestScope.meishi.id }"/>
