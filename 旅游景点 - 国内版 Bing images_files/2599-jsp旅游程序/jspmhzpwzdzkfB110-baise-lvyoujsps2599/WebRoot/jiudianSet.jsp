...
<form action="<%=path %>/jiudianSet.action" method="post" name="formAdd" >
	酒店修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="biaoti" id="biaoti" value="${requestScope.jiudian.biaoti }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<textarea name="neirong" style="width:670px;height:200px;visibility:;">${requestScope.jiudian.neirong }</textarea>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="dizhi" id="dizhi" value="${requestScope.jiudian.dizhi }" size="90"/>
							</td>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="image" id="image" value="${requestScope.jiudian.image }" size="50" readonly="readonly"/>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="shijian" id="shijian" size="90" value="${requestScope.jiudian.shijian }" />
						    </td>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="hidden" name="id" value="${requestScope.jiudian.id }"/>
