...
<head>
	...
	<script language="javascript">
		...
		function check()
		{
                ...
                if(document.formAdd.liuyanshijian.value=="")
                {
...
<form action="<%=path %>/liuyanSet.action" method="post" name="formAdd" >
	留言修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="biaoti" id="biaoti" value="${requestScope.liuyan.biaoti }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<textarea name="neirong" style="width:670px;height:200px;visibility:;">${requestScope.liuyan.neirong }</textarea>
							</td>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="liuyanshijian" id="liuyanshijian" size="90" value="${requestScope.liuyan.liuyanshijian }" />
						    </td>
						...
						<tr>
                            ...
                            <td width="90%" bgcolor="#FFFFFF" align="left">
                                <select name="usersid" id="usersid" style="width: 280px;">
                                    <option value="${requestScope.liuyan.users.id }">${requestScope.liuyan.users.loginname }</option>
                                </select>
                            </td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="huifu" id="huifu" value="${requestScope.liuyan.huifu }" size="90"/>
							</td>
