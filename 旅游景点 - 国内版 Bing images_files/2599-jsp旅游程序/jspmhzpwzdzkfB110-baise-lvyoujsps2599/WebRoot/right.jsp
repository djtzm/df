    ...
    <TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR
            ...
            <TD width=10 height="47"><SPAN
                    style="FLOAT: left; BACKGROUND-IMAGE: url(images/main_hl.gif); WIDTH: 10px; BACKGROUND-REPEAT: no-repeat; HEIGHT: 47px"></SPAN>
            </TD>
            <TD height="47">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="120" style="width:120px; background-image:url(images/main_hb.gif)" align="center">
                            <font color="#FFFFFF" size="-1">主界面</font></td>
        ...
        <TR>
            ...
            <TD
                ...
                <iframe frameBorder="0" id="hsgmain" name="hsgmain" scrolling="yes" src="sy.jsp"
