...
<form action="<%=path %>/yudingSet.action" method="post" name="formAdd" >
	预定修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="biaoti" id="biaoti" value="${requestScope.yuding.biaoti }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
						        <select name="jiudianid" id="jiudianid" style="width: 280px;">
									<option value="${requestScope.yuding.jiudian.id }">${requestScope.yuding.jiudian.biaoti }</option>
								</select>
						    </td>
						...
						<tr>
                            ...
                            <td width="90%" bgcolor="#FFFFFF" align="left">
                                <select name="usersid" id="usersid" style="width: 280px;">
                                    <option value="${requestScope.yuding.users.id }">${requestScope.yuding.users.loginname }</option>
                                </select>
                            </td>
						   ...
						   <%-- <td width="90%" bgcolor="#FFFFFF" align="left">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="riqi" id="riqi"  style="border:1px solid #cccccc;"
									   ...
									   value="${requestScope.yuding.riqi }" />
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="xingming" id="xingming" value="${requestScope.yuding.xingming }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="dianhua" id="dianhua" value="${requestScope.yuding.dianhua }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="beizhu" id="beizhu" value="${requestScope.yuding.beizhu }" size="90"/>
							</td>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="hidden" name="id" value="${requestScope.yuding.id }"/>
