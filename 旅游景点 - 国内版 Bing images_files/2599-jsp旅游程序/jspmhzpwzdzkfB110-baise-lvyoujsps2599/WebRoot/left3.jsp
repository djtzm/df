...
<SCRIPT type=text/javascript>
    ...
    b1 = new TreeNode('用户添加', 'userAdd.jsp', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    b1 = new TreeNode('修改密码', 'userPw.jsp', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    b1 = new TreeNode('修改资料', 'userXinxiSet.jsp', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    root.add(a1);


    a1 = new TreeNode('任务管理');
    b1 = new TreeNode('任务查询', 'renwuChakan.action', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    root.add(a1);


    a1 = new TreeNode('招聘计划管理');
    b1 = new TreeNode('招聘计划查询', 'zhaopinChakan.action', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    root.add(a1);
