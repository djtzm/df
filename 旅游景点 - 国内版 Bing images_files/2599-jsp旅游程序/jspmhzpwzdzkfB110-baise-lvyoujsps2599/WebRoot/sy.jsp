...
<table width="100%" height="60" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#D9E9FF"
       style="border-collapse:collapse">
    <TBODY>
    <TR
            align=middle bgColor=#ffffff>
        <td colspan="4" bgColor=#CADCEA><strong>欢迎您进入！</strong></td>
    </TR>
    <TR align=middle
        bgColor=#ffffff>
        <TD width="14%" align="left" valign="bottom">当前用户：</TD>
        <TD width="37%" align="left" valign="bottom"><font class="t4">${sessionScope.user.loginname}</font></TD>
        <TD width="9%" align="left" valign="bottom">您的权限：</TD>
        <TD width="40%" align="left" valign="bottom"><font class="t4">${sessionScope.user.typename}</font></TD>
    </TR>
    <%--<TR align=middle
        bgColor=#ffffff>
...
<%--<table width="100%" height="193" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#D9E9FF"
    ...
    <TR
            align=middle bgColor=#ffffff>
        <td colspan="2" bgColor=#CADCEA><strong>xxxx</strong></td>
    </TR>
    <TR align=middle
        bgColor=#ffffff>
