...
<head>
	...
	<script language="javascript">
		...
		function dateDiff(){
			...
			//document.getElementById("jine").value = result*${requestScope.jiudian.id };
		}
...
<div class="wrapper">
	<div class="news_con">
		<div class="news_list_con clearfix">
			...
			<form action="<%=path %>/yudingAddQian.action" method="post" name="formAdd" id="formAdd" >
				<table width="98%" height="516" border="1" align="center" cellpadding="3" cellspacing="1"
					...
					<tr>
						...
						<td >
							<select name="jiudianid" id="jiudianid"
								...
								<option value="${requestScope.jiudian.id }">${requestScope.jiudian.biaoti }</option>
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="2">
							<%--<input type="hidden" name="jiudianid" value="${requestScope.jiudian.id }"/>--%>
