...
<SCRIPT type=text/javascript>
    ...
    a1 = new TreeNode('酒店预定管理');

    b1 = new TreeNode('我的酒店预定查询', 'yudingChakanMy.action', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    root.add(a1);


    a1 = new TreeNode('线路预定管理');

    b1 = new TreeNode('我的线路预定查询', 'yuyueChakanMy.action', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    root.add(a1);
    ...
    b1 = new TreeNode('我的评论查询', 'pinglunChakanMy.action', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    b1 = new TreeNode('我的收藏查询', 'shoucangChakanMy.action', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    b1 = new TreeNode('我的留言管理', 'liuyanChakanMy.action', 'tree_node.gif', null, 'tree_node.gif', null);
    a1.add(b1);
    root.add(a1);
