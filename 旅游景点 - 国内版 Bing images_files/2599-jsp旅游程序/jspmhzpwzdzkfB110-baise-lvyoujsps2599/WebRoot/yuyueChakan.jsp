	...
	<head>
		...
		<script language="javascript">
           ...
           function yuyueDel(id)
           {
               if(confirm('您确定删除吗?'))
               {
                   window.location.href="<%=path %>/yuyueDel.action?id="+id+"&path=yuyueChakan.action";
               }
           }
           //修改信息
           ...
           function go(index)
           {
               ...
               document.form123.action="yuyueChakan.action"
            ...
            function yuyueSet(id,property,value)
           {
               if(confirm('您确定操作吗?'))
               {
				   ...
				   document.formset.action="yuyueSet.action?id="+id+"&path=yuyueChakan.action";
...
/*			function tupianGetByxinwen_id(xinwen_id)
	...
	<body onload="init()" leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<%--<form action="<%=path %>/yuyueSearchChakan.action" name="formSearch" id="formSearch" method="post">
