				...
				<ul>
					...
					<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
						...
						<tr>
							...
							<td align=left><a href=<%=path %>/${requestScope.chanpin.image } target=_blank><img
									src="<%=path %>/${requestScope.chanpin.image }" width=228 height=215 border=0></a></td>
							<%--<td width="39%" align="left">
								<img src="<%=path %>/${requestScope.chanpin.image }" alt="" width="550" height="350"/>
							</td>--%>
						</tr>
						<tr>
							<td width="39%" height="44">
							...
							<td width="39%" >
								<a href="#" onclick="down1('${requestScope.chanpin.image }','${requestScope.chanpin.image }')" style="color: red">下载</a>
							</td>
						</tr>
