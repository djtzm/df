...
<head>
	...
	<script language="javascript">
		...
		function check()
		{
			                if(document.formAdd.leibie.value=="")
                {
                    alert("please input:类别");
                    return false;
                }

                if(document.formAdd.addtime.value=="")
                {
...
<form action="<%=path %>/dxSet.action" method="post" name="formAdd" >
	信息介绍修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="leibie" id="leibie" value="${requestScope.dx.leibie }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<textarea name="content" style="width:670px;height:200px;visibility:;">${requestScope.dx.content }</textarea>
							</td>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="addtime" id="addtime" size="90" value="${requestScope.dx.addtime }" />
						    </td>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="hidden" name="id" value="${requestScope.dx.id }"/>
