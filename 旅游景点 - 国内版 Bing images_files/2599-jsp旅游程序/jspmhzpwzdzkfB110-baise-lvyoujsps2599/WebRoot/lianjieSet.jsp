...
<form action="<%=path %>/lianjieSet.action" method="post" name="formAdd" >
	友情链接修改
	<br><br>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="name" id="name" value="${requestScope.lianjie.name }" size="90"/>
							</td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="url" id="url" value="${requestScope.lianjie.url }" size="90"/>
							</td>
