...
<body onload="init()">
<form action="<%=path %>/liuyanAdd.action" method="post" id="formAdd" name="formAdd">
    用户留言添加
    <br><br>
                ...
                <select name="usersid"
                    ...
                    <option value="${requestScope.users.id }">${requestScope.users.loginname }</option>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="liuyanshijian" id="liuyanshijian" size="90" value="<%=new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new Date())%>"/>
						    </td>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="huifu" id="huifu" size="90"/>
							</td>
