...
<body onload="init()">
<form action="<%=path %>/jingdianAdd.action" method="post" id="formAdd" name="formAdd">
    类别景点添加
    <br><br>
                ...
                <select name="leibieid"
                    ...
                    <option value="${requestScope.leibie.id }">${requestScope.leibie.mingcheng }</option>
					    ...
					    <tr>
							...
							<td width="90%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="jiage" id="jiage" size="90"/>
							</td>
					    ...
					    <tr>
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="shijian" id="shijian" size="90" value="<%=new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new Date())%>"/>
						    </td>
