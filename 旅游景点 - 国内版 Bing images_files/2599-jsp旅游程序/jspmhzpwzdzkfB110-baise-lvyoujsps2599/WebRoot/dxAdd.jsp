...
<body onload="init()" >
<form action="<%=path %>/dxAdd.action" method="post" id="formAdd" name="formAdd" >
	信息介绍添加
	<br><br>
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
		   style="border-collapse:collapse">
							...
							<td>
								<input type="text" name="leibie" id="leibie" size="70"/>
							</td>
					    ...
					    <tr>
							...
							<td width="80%" bgcolor="#FFFFFF" align="left">
								<textarea name="content" style="width:670px;height:200px;visibility:;"></textarea>
							</td>
					    ...
					    <tr>
						    ...
						    <td>
						        <input type="text" name="addtime" id="addtime" size="70" value="<%=new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new Date())%>"/>
						    </td>
