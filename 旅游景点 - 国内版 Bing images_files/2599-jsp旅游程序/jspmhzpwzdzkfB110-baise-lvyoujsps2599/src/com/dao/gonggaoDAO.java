...
// property constants
    ...
    public gonggao merge(gonggao detachedInstance)
    {
        ...
        try
        {
            gonggao result = (gonggao) getHibernateTemplate().merge(
                    detachedInstance);
    ...
    public gonggao findById(java.lang.Integer id)
    {
        ...
        try
        {
            gonggao instance = (gonggao) getHibernateTemplate().get(
                    "com.model.gonggao", id);
            return instance;
        } catch (RuntimeException re)
        {
	...
	public List findByTupian(Object tupian)
	{
		return findByProperty(Tupian, tupian);
	}
